/*
 LCDSerial.h - Library for controlling a SparkFun LCDSerial module
...
#define LCDSerial_DEBUG

class LCDSerial : public SerialPi 
{
   public:
      LCDSerial(const char *serialPort="/dev/ttyUSB0");
